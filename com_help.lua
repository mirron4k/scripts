...
function main()
	...
	wait(500)
	sampAddChatMessage("{f09205}[Aries-Help]: {FFFFFF}Успешно загружено!", -1)
	sampAddChatMessage("{f09205}[Aries-Help]: {FFFFFF}Команда для открытия списка - {f09205}/chelp", -1)
	sampAddChatMessage("{f09205}[Aries-Help]: {FFFFFF}Приятной игры на {f09205}Aries RolePlay", -1)
